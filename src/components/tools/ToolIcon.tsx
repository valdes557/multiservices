...
import { Coins, FileText, SpellCheck, Landmark, Ruler, TrendingUp, User, Image as ImageIcon, Braces, FileCode, Binary, Fingerprint, KeyRound, Key, Map, Bot, Code2, QrCode, Palette, PiggyBank, Receipt, Percent, Calculator, type LucideProps } from 'lucide-react';
