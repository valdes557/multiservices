...
import { Coins, FileText, SpellCheck, Landmark, Ruler, TrendingUp, User, Image as ImageIcon, Braces, FileCode, Binary, Fingerprint, KeyRound, Key, Map, Bot, Code2, QrCode, Palette, PiggyBank, Receipt, Percent, Calculator, FileSpreadsheet, FileCheck, GraduationCap, ArrowLeftRight, Target, FileImage, Maximize2, Stamp, Crop, AlignLeft, Repeat, Mail, Package, Share2, Youtube, Hash, type LucideProps } from 'lucide-react';
