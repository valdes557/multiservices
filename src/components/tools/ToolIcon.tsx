...
import { Coins, FileText, SpellCheck, Landmark, Ruler, TrendingUp, User, Image as ImageIcon, Braces, FileCode, Binary, Fingerprint, KeyRound, Key, Map, Bot, Code2, QrCode, Palette, PiggyBank, Receipt, Percent, Calculator, FileSpreadsheet, FileCheck, GraduationCap, ArrowLeftRight, Target, type LucideProps } from 'lucide-react';
